...
public class ContainerRocketLauncher extends Container {
	
	private TileEntityRocketLauncher tile;
	
	public ContainerRocketLauncher(IInventory inventory, TileEntityRocketLauncher tile) {
		this.tile = tile;
        int i;
        int j;
